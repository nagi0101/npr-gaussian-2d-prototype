...
class Gaussian2D:
    ...
    def transform(self, transform_matrix: np.ndarray) -> 'Gaussian2D':
        ...
        # 만약 non-uniform scaling이 필요하면 추가 구현 필요
    ...
    def compute_covariance_2d(self, view_matrix: Optional[np.ndarray] = None) -> np.ndarray:
        """
    ...
    def __repr__(self) -> str:
        return (f"Gaussian2D(pos={self.position[:2]}, "
